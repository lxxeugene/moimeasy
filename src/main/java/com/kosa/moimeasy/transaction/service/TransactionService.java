...
public interface TransactionService {
    ...
    List<Transaction> findTransactionsAfter(Moeim moeim, LocalDateTime transactionAt);

    // 특정 시점 이후 발생한 모임 계좌의 출금 내역 조회
    List<Transaction> findWithdrawalsAfter(Moeim moeim, LocalDateTime transactionAt);
